        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/nature.jpeg" alt="" class="card-img">
          ...
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/wedding.jpeg" alt="" class="card-img">
              <div class="card-img-overlay">
          ...
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/party.jpeg" alt="" class="card-img">
              <div class="card-img-overlay">
          ...
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/business.jpeg" alt="" class="card-img">
              <div class="card-img-overlay">
          ...
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/fashion.jpeg" alt="" class="card-img">
              <div class="card-img-overlay">
          ...
          <div class="col-lg-4 col-sm-6 my-5">
            <div class="card border-0 card-shadow">
              <img src="img/images/family.jpeg" alt="" class="card-img">
              <div class="card-img-overlay">
